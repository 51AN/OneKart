...
const { getMyProduct, updateProduct, deleteProduct, topSellingProducts, getBranchProducts, searchProducts, searchProductsManager } = require('../controllers/productController');
...
router.post("/searchProductsManager/", searchProductsManager)
